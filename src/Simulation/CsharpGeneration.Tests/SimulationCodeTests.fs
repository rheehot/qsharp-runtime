...
#line hidden
    ...
    public abstract partial class emptyOperation : Operation<QVoid, QVoid>, ICallable
    {
        ...
        public static HoneywellExecutable<QVoid, QVoid> Info => new HoneywellExecutable<QVoid, QVoid>(typeof(emptyOperation));
...
"""
    ...
    public abstract partial class randomAbstractOperation : Unitary<(Qubit,Basis,(Pauli,IQArray<IQArray<Double>>,Boolean),Int64)>, ICallable
    {
        ...
        public static IonQExecutable<(Qubit, Basis, (Pauli, IQArray<IQArray<Double>>, Boolean), Int64), QVoid> Info => new IonQExecutable<(Qubit, Basis, (Pauli, IQArray<IQArray<Double>>, Boolean), Int64), QVoid>(typeof(randomAbstractOperation));
...
"""
    ...
    public partial class oneQubitOperation : Unitary<Qubit>, ICallable
    {
        ...
        public static QCIExecutable<Qubit, QVoid> Info => new QCIExecutable<Qubit, QVoid>(typeof(oneQubitOperation));
...
"""
    ...
    public abstract partial class genCtrl3<__X__, __Y__, __Z__> : Controllable<(__X__,(Int64,(__Y__,__Z__),Result))>, ICallable
    {
        ...
        public static HoneywellExecutable<(__X__, (Int64, (__Y__, __Z__), Result)), QVoid> Info => new HoneywellExecutable<(__X__, (Int64, (__Y__, __Z__), Result)), QVoid>(typeof(genCtrl3<__X__,__Y__,__Z__>));
...
"""   
    ...
    public partial class composeImpl<__A__, __B__> : Operation<(ICallable,ICallable,__B__), QVoid>, ICallable
    {
        ...
        public static IonQExecutable<(ICallable, ICallable, __B__), QVoid> Info => new IonQExecutable<(ICallable, ICallable, __B__), QVoid>(typeof(composeImpl<__A__,__B__>));
...
"""   
    ...
    public abstract partial class genF1<__A__> : Function<__A__, QVoid>, ICallable
    {
        ...
        public static QCIExecutable<__A__, QVoid> Info => new QCIExecutable<__A__, QVoid>(typeof(genF1<__A__>));
